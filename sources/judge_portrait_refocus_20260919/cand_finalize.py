...
from cand_capture import HERE, profile_evidence

COURT='U.S. District Court for the Northern District of California'
ENTITY_PATH=ROOT/'sources/judge_entities_20260918/entities.jsonl'
BRIDGES={
 'Susan Illston':('judge-entity-5e5bd2c3ab26ac74cd84a16e',[
  ('undergraduate education','Duke University, B.A., 1970','education','Duke University, B.A., 1970'),
  ('law education','Stanford Law School, J.D., 1973','education','Stanford Law School, J.D., 1973'),
  ('commission date','received commission on May 26, 1995','appointments','Commission Date: 1995-05-26')]),
 'Haywood S. Gilliam, Jr.':('judge-entity-f6dea9d1947535460acbe490',[
  ('undergraduate education','Yale University, B.A., 1991','education','Yale University, B.A., 1991'),
  ('law education','Stanford Law School, J.D., 1994','education','Stanford Law School, J.D., 1994'),
  ('commission date','received commission on December 19, 2014','appointments','Commission Date: 2014-12-19')]),
 'Phyllis J. Hamilton':('judge-entity-47357f4b432ac00de7a496d2',[
  ('undergraduate education','Stanford University, B.A., 1974','education','Stanford University, B.A., 1974'),
  ('commission date','received commission on May 25, 2000','appointments','Commission Date: 2000-05-25'),
  ('magistrate service','U.S. Magistrate Judge, U.S. District Court for the Northern District of California, 1991-2000','service','U.S. Magistrate Judge, U.S. District Court for the Northern District of California, 1991-2000')]),
 'Araceli Martinez-Olguin':('judge-entity-1b4c8e98066f77733567c2dd',[
  ('undergraduate education','Princeton University, A.B., 1999','education','Princeton University, A.B., 1999'),
  ('law education','University of California, Berkeley, School of Law, J.D., 2004','education','University of California, Berkeley, School of Law, J.D., 2004'),
  ('commission date','received commission on March 3, 2023','appointments','Commission Date: 2023-03-03')]),
 'Edward J. Davila':('judge-entity-ad72da5a57df321a7b29a301',[
  ('commission date','received commission on March 3, 2011','appointments','Commission Date: 2011-03-03'),
  ('state judicial service','Judge, Superior Court of California, County of Santa Clara, 2001-2011','professional_career','Judge, Superior Court of California, County of Santa Clara, 2001-2011')]),
 'Noël Wise':('judge-entity-f515f28c3bce92a54937fa3e',[
  ('state judicial service','In 2014 Governor Jerry Brown appointed Judge Wise to the California Superior Court, County of Alameda, where she served until 2024','professional_career','Judge, Superior Court of California, County of Alameda, 2014-2024'),
  ('appellate assignment','From 2021 to 2022, Judge Wise sat on assignment for Division Seven of the California Second District Court of Appeal','professional_career','Judge pro tem, California Court of Appeal, Second District, 2021-2022'),
  ('judicial clerkship','served as a law clerk to Justice Harry Lee Anstead','professional_career','Law clerk, Hon. Harry Lee Anstead, Florida District Court of Appeal, Fourth District, 1993-1994')]),
}
...
def main():
    ...
    summary={'validated_at':datetime.now(timezone.utc).isoformat(),'official_roster_profile_links':36,'already_installed_from_roster':14,
        'additional_profile_links':22,'selected_profile_requests':20,'successful_profile_captures':16,'profile_request_failures':4,
        'decorative_gavel_excluded':1,'source_bound_portrait_references':len(profiles),'downloaded_valid_images':len(images),
        ...
        'single_same_url_image_retry_after_remote_disconnect':1,'paid_calls':0,'shared_host_minimum_delay_seconds':2,
        'new_images_attached':0,'expected_verified_total_after_root_integrates':43+len(accepted),
