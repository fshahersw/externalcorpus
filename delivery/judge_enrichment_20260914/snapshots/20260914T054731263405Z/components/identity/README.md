...
This offline layer preserves all 6,737 source observations from the pinned sealed judge snapshot. It creates 6,494 identity groups, including unresolved single observations. These counts are not a count of distinct people or current judges.
